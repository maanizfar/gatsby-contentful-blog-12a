...
export interface BlogPostDataQuery_contentfulBlogPost_author_profilePicture_fluid {
  base64: string | null;
  aspectRatio: number;
  src: string;
  srcSet: string;
...
export interface BlogPostDataQuery_contentfulBlogPost_author_profilePicture {
  fluid: BlogPostDataQuery_contentfulBlogPost_author_profilePicture_fluid | null;
}
