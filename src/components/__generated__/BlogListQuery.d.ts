...
export interface BlogListQuery_allContentfulBlogPost_edges_node_author_profilePicture_fixed {
  base64: string | null;
  width: number;
  height: number;
  src: string;
...
export interface BlogListQuery_allContentfulBlogPost_edges_node_author_profilePicture {
  fixed: BlogListQuery_allContentfulBlogPost_edges_node_author_profilePicture_fixed | null;
}
